...
hero:
  ...
  text: Model factories + faker for TypeScript
  tagline: Laravel-inspired. Seedable. Locale-aware. Zero runtime dependencies.
  actions:
    - theme: brand
      text: Get Started
      link: /guide/
    - theme: alt
      text: View on GitHub
      link: https://github.com/anilkumarthakur60/factory
...
features:
  ...
  - icon: 🧪
    title: Built for tests
    details: 'snapshot() helper normalises payloads for stable test runner snapshots. Type-safe overrides everywhere.'
---
